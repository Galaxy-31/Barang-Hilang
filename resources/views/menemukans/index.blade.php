    ...
    <div class="about-section">
        ...
        <div class="inner-width">
            ...
            <div class="container-fluid row">
                @foreach ($menemukans as $menemukan)
                    <div class="col-sm-4">
                        <div class="card">
                            <img src="
                            @if ($menemukan->foto) 
                            ...
                            "
                                class="card-img-top" alt="{{ $menemukan->nama }}">
                            <div class="card-body">
                                <h5 class="card-title">{{ $menemukan->tipe }}</h5>
                                <p class="card-text">{{ $menemukan->keterangan }}</p>
                                <a href="{{ route('menemukans.show', $menemukan->id) }}" class="btn btn-primary">Cek
                                    Detail</a>
                            </div>
                        </div>
                    </div>
